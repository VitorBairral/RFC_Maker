class Cavity:
    """This module is designed to generate Autofish input codes in order to 
        ...
        such as it geometry through a dictionary with this structure:\n
            settings = {
                ...
                "E0": <float>, #Sets the value of the initial electric field inside the cavity
    ...
    def generate(self):
        ...
        if self.settings["full"]:
            ...
            comprimento = self.settings["cell_length"]
